...
void ObjectAccessor::RemoveCorpse(Corpse* corpse)
{
    ...
    // Critical section
    {
        ...
        CellPair cell_pair = Skyfire::ComputeCellPair(corpse->GetPositionX(), corpse->GetPositionY());
...
Corpse* ObjectAccessor::ConvertCorpseForPlayer(uint64 player_guid, bool insignia)
{
    ...
    sLog->outDebug (LOG_FILTER_NETWORKIO, "Deleting Corpse and spawned bones.");
