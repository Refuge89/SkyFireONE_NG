...
{
    m_UpdateTimer = 0;
    //sLog->outDebug (LOG_FILTER_NETWORKIO, "Instantiating OutdoorPvPMgr");
}

OutdoorPvPMgr::~OutdoorPvPMgr()
{
    //sLog->outDebug (LOG_FILTER_NETWORKIO, "Deleting OutdoorPvPMgr");
...
void OutdoorPvPMgr::InitOutdoorPvP()
{
    ...
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : HP init failed.");
        delete pOP;
    }
    else
    {
        m_OutdoorPvPSet.push_back(pOP);
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : HP successfully initiated.");
    }
    ...
    if (!pOP->SetupOutdoorPvP())
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : NA init failed.");
        delete pOP;
    }
    else
    {
        m_OutdoorPvPSet.push_back(pOP);
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : NA successfully initiated.");
    }
    ...
    if (!pOP->SetupOutdoorPvP())
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : TF init failed.");
        delete pOP;
    }
    else
    {
        m_OutdoorPvPSet.push_back(pOP);
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : TF successfully initiated.");
    }
    ...
    if (!pOP->SetupOutdoorPvP())
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : ZM init failed.");
        delete pOP;
    }
    else
    {
        m_OutdoorPvPSet.push_back(pOP);
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : ZM successfully initiated.");
    }
    ...
    if (!pOP->SetupOutdoorPvP())
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : SI init failed.");
        delete pOP;
    }
    else
    {
        m_OutdoorPvPSet.push_back(pOP);
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : SI successfully initiated.");
    }
    ...
    if (!pOP->SetupOutdoorPvP())
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : EP init failed.");
        delete pOP;
    }
    else
    {
        m_OutdoorPvPSet.push_back(pOP);
        sLog->outDebug (LOG_FILTER_NETWORKIO, "OutdoorPvP : EP successfully initiated.");
    }
}
