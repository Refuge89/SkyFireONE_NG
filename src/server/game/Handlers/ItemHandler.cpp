...
{
    //sLog->outDebug (LOG_FILTER_NETWORKIO, "WORLD: CMSG_SWAP_INV_ITEM");
...
void WorldSession::HandleSellItemOpcode(WorldPacket& recv_data)
{
    ...
    if (!creature)
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "WORLD: HandleSellItemOpcode - Unit (GUID: %u) not found or you can't interact with him.", uint32(GUID_LOPART(vendorguid)));
...
void WorldSession::SendListInventory(uint64 vendorguid)
{
    ...
    float discountMod = _player->GetReputationPriceDiscount(creature);
