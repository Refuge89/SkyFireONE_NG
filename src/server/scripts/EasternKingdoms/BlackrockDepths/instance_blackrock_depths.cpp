...
struct instance_blackrock_depths : public ScriptedInstance
{
    ...
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "TSCR: Instance Blackrock Depths: SetData64 update (Type: %u Data %u)", type, data);
    ...
    {
        sLog->outDebug (LOG_FILTER_NETWORKIO, "TSCR: Instance Blackrock Depths: SetData update (Type: %u Data %u)", type, data);
